...
def finde_neue_memecoins(max_results=50):
...
def coin_engagement(coin, max_results=30):
...
def analyse_meme_hype():
    ...
    top_coins = neue_coins[:5]
    daten = [coin_engagement(coin) for coin in top_coins]
...
def dashboard():
    ...
    <body>
        ...
        <p>Automatische Aktualisierung alle 90 Sekunden</p>
        {table_html}
    </body>
    </html>
    """
